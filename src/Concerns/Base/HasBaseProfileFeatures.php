...
trait HasBaseProfileFeatures
{
    ...
    /**
     * Determine if the political is managing profile photos.
     */
    public static bool $managesProfilePhotos = false;

    /**
     * Determine if the political has a profile photo disk.
     */
    public static string $profilePhotoDisk = 'public';

    /**
     * Determine if the political has a profile photo storage path.
     */
    public static string $profilePhotoStoragePath = 'profile-photos';

    /**
     * Determine if the political is supporting API features.
     */
    ...
    /**
     * Determine if Political is managing profile photos.
     */
    ...
    /**
     * Determine if Political is supporting API features.
     */
