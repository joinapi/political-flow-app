...
trait HasProfilePhoto
{
    ...
    {
        $storagePath = PoliticalFlow::profilePhotoStoragePath();
    ...
    {
        if ($this->profile_photo_path === null || ! PoliticalFlow::managesProfilePhotos()) {
            return;
        }
    ...
    {
        return isset($_ENV['VAPOR_ARTIFACT_NAME']) ? 's3' : PoliticalFlow::profilePhotoDisk();
    }
}
