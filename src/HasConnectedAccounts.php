...
trait HasConnectedAccounts
{
    ...
    public function currentConnectedAccount(): BelongsTo
    {
        ...
        return $this->belongsTo(PoliticalFlow::connectedAccountModel(), 'current_connected_account_id');
    }
    ...
    {
        return $this->hasMany(PoliticalFlow::connectedAccountModel(), 'user_id', $this->getAuthIdentifierName());
    }
}
