<x-political-flow::grid-section md="2">
    <x-slot name="title">
        {{ __('political-flow::default.grid_section_titles.update_password') }}
    </x-slot>

    <x-slot name="description">
        {{ __('political-flow::default.grid_section_descriptions.update_password') }}
    </x-slot>

    <x-filament::section>
        <x-filament-panels::form wire:submit="updatePassword">
            <x-filament-forms::field-wrapper id="current_password" statePath="current_password" required="required" label="{{ __('political-flow::default.fields.current_password') }}">
